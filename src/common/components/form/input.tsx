...
export const Input: React.StatelessComponent<Props> = (props) => {
  return (
    <div className={formatWrapperClass(props)}>
      <label htmlFor={props.name} style={{ float: 'left',marginRight:'10px',height:'38px',lineHeight:'38px'}}>{props.label}</label>
      <div className="field" style={{ float: 'left',width:'200px'}}>
        <input type="text"
          name={props.name}
